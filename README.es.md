...
KEYWORDS: `traductor EPUB`, `herramienta de traduccion EPUB`, `traduccion con IA`, `traductor de ebooks`, `Ollama`, `Google Gemini`, `Translation Memory`, `QA gate`, `Tkinter`, `Python`.
